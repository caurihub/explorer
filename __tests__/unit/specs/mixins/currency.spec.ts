...
describe("Mixins > Currency", () => {
  ...
  describe("rawCurrency", () => {
    it("should display selected cryptocurrency with 8 digits or less", () => {
      ...
      expect(wrapper.vm.rawCurrency(10.1234567891234, "CAU")).toEqual(displayCrypto(10.12345679));
      ...
      expect(wrapper.vm.rawCurrency(10.12345, "CAU")).toEqual(displayCrypto(10.12345));
    });
  ...
  describe("readableCrypto", () => {
    ...
    it("should return crypto value in readable format, including symbol", () => {
      store.dispatch("network/setSymbol", "ꚦ");
      expect(wrapper.vm.readableCrypto(10 * Math.pow(10, 8))).toEqual(displayCrypto(10) + " ꚦ");
      expect(wrapper.vm.readableCrypto(10 * Math.pow(10, 8), true)).toEqual(displayCrypto(10) + " ꚦ");
      expect(wrapper.vm.readableCrypto(10.12345678912345 * Math.pow(10, 8), true)).toEqual(
        displayCrypto(10.12345679) + " ꚦ",
      );
      expect(wrapper.vm.readableCrypto(10.1234 * Math.pow(10, 8), true)).toEqual(displayCrypto(10.1234) + " ꚦ");
    });
  ...
  describe("readableCurrency", () => {
    ...
    it("should properly format the given data", () => {
      expect(wrapper.vm.readableCurrency(100000000, null, "CAU")).toEqual("1 ꚦ");
