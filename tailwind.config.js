module.exports = {
  ...
  theme: {
    ...
    boxShadow: {
      ...
      button: "0 5px 15px rgba(255, 127, 42, 0.34)",
    },
    ...
    colors: {
      ...
      "grey-darkest": "#6C5353", // UPDATED
      "grey-darker": "#606f7b",
      "grey-dark": "#373b4a", // UPDATED
      grey: "#AC9393", // UPDATED
      "grey-light": "#ffe6d5", // UPDATED
      "grey-lighter": "#e3e6f2", // UPDATED
      "grey-lightest": "#fbf7f7", // UPDATED
      white: "#ffffff",
      ...
      "blue-darkest": "#241c1c", // UPDATED
      "blue-darker": "#282a38", // UPDATED
      "blue-dark": "#2779bd",
      blue: "#ff5000", // UPDATED
      "blue-light": "#6f77a4", // UPDATED
      "blue-lighter": "#f5eeee", // UPDATED
