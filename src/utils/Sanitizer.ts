...
export class Sanitizer {
  ...
  private removeSpam(value: string): string {
    ...
    const exceptions = [
      (match) => match.url === "http://dpos.cauriy-delegate.info",
      (match) => match.url === "http://cauriy-delegate.info",
      (match) => match.url === "https://caurifun.io/",
      (match) => match.url === "https://cauri.cm/",
      (match) => match.raw === "Caurirelay.com",
    ];
